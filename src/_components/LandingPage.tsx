                ...
                <div className="menu">
                    <div className="menu_content">
                        ...
                        <div className="login-wrap">
                            <Link className="nav-item" to={(props.payload !== undefined ? !props.payload.isAuth : false) ? '/login' : ''} onClick={(props.payload !== undefined ? props.payload.isAuth : false) ? handleLogout : undefined} >{(props.payload !== undefined ? props.payload.isAuth : false) ? '로그아웃' : '로그인'}</Link>
                            {(props.payload !== undefined ? props.payload.isAuth : false) ? <div></div> : <Link className="nav-item " to="register">회원가입</Link>}
                        </div>
                    </div>
                </div>
                <main id="container">
